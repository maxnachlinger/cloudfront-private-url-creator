...
module.exports.signUrl = function (resource, config, signCb) {
...
module.exports.getSignatureQueryString = function (resource, config, signCb) {
  ...
  const policy = buildPolicy(JSON.parse(JSON.stringify(config), function (key, value) {
